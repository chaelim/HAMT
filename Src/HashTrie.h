 ...
 */
template<class T, class K>
void THashTrie<T, K>::ArrayMappedTrie::ClearAll (ArrayMappedTrie * amt, uint32 depth)
{
 ...
 */
template<class T, class K>
void THashTrie<T, K>::ArrayMappedTrie::DestroyAll(ArrayMappedTrie * amt, uint32 depth)
{
